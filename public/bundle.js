...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _form_setUser = __webpack_require__(225);

	var _form_setUser2 = _interopRequireDefault(_form_setUser);

	var _form_setMenu = __webpack_require__(226);

	var _form_setMenu2 = _interopRequireDefault(_form_setMenu);

	var _Form_Confirmation = __webpack_require__(228);

	var _Form_Confirmation2 = _interopRequireDefault(_Form_Confirmation);
	...
	module.exports = _react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    _reactRouter.Route,
	    { path: "/", component: _form2.default },
	    _react2.default.createElement(_reactRouter.Route, { path: "/step_1", component: _form_setUser2.default }),
	    _react2.default.createElement(_reactRouter.Route, { path: "/step_2", component: _form_setMenu2.default }),
	    _react2.default.createElement(_reactRouter.Route, { path: "/step_3", component: _Form_Confirmation2.default }),
	    _react2.default.createElement(_reactRouter.IndexRoute, { component: _form_setUser2.default })
	  )
	);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _PropTypes2 = __webpack_require__(162);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _deprecateObjectProperties = __webpack_require__(163);
	...
	var _routerWarning = __webpack_require__(164);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _makeStateWithLocation = __webpack_require__(195);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _form_confirmation = __webpack_require__(227);
	...
	var Form = function (_Component) {
		...
		_createClass(Form, [{
			key: "setUser",
			value: function setUser(name, password) {
				this.setState({
					name: name,
					password: password
				});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Form_SetUser = function (_Component) {
		_inherits(Form_SetUser, _Component);

		function Form_SetUser(props) {
			_classCallCheck(this, Form_SetUser);

			var _this = _possibleConstructorReturn(this, (Form_SetUser.__proto__ || Object.getPrototypeOf(Form_SetUser)).call(this, props));
		...
		_createClass(Form_SetUser, [{
			...
			value: function handleClick() {
				this.props.setUser(this.state.name, this.state.password);
			}
		}, {
			key: "render",
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement("input", { id: "icon_prefix", type: "text", className: "validate", name: "name", value: this.state.name, onChange: this.handleChange }),
						_react2.default.createElement(
							"label",
							{ htmlFor: "icon_prefix" },
							"User Name"
					...
					_react2.default.createElement(
						"div",
						{ className: "input-field" },
						_react2.default.createElement("input", { id: "icon_prefix", type: "password", className: "validate", name: "password", value: this.state.password, onChange: this.handleChange }),
						_react2.default.createElement(
							"label",
							{ htmlFor: "icon_prefix" },
							"password"
					...
					_react2.default.createElement(
						_reactRouter.Link,
						{ to: "/step_2", className: "waves-effect waves-light btn", onClick: this.handleClick },
						"next"
					)
				);
			}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Form_SetMenu = function (_Component) {
		_inherits(Form_SetMenu, _Component);

		function Form_SetMenu(props) {
			_classCallCheck(this, Form_SetMenu);

			var _this = _possibleConstructorReturn(this, (Form_SetMenu.__proto__ || Object.getPrototypeOf(Form_SetMenu)).call(this, props));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Form_Confirmation = function (_Component) {
		_inherits(Form_Confirmation, _Component);

		function Form_Confirmation(props) {
			_classCallCheck(this, Form_Confirmation);

			var _this = _possibleConstructorReturn(this, (Form_Confirmation.__proto__ || Object.getPrototypeOf(Form_Confirmation)).call(this, props));
		...
		_createClass(Form_Confirmation, [{
			key: "render",
			value: function render() {
				return _react2.default.createElement(
					"h1",
	...
	exports.default = Form_Confirmation;
